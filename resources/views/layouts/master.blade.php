...
<head>
    ...
    <!-- iCheck -->
    <link href="{{URL::to('/gentelella')}}/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="{{URL::to('/gentelella')}}/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="{{URL::to('/gentelella')}}/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="{{URL::to('/gentelella')}}/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{URL::to('/')}}" class="site_title"><i class="fa fa-area-chart"></i> <span>Nomina</span></a>
                </div>
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="{{URL::to('/images/user_images/default_image.png')}}" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="{{URL::to('/')}}"><i class="fa fa-home"></i> Dashboard</a>
                            </li>
                        </ul>
                        <ul class="nav side-menu">
                            <li><a href="{{URL::to('/transfer')}}"><i class="fa fa-money"></i> Transfer</a>
                            </li>
                        </ul>
                        <ul class="nav side-menu">
                            <li><a href="{{URL::to('/mutasi')}}"><i class="fa fa-list-alt"></i>List Mutation</a>
                            </li>
                        </ul>
                        <ul class="nav side-menu">
...
<!-- Chart.js -->
<script src="{{URL::to('/gentelella')}}/vendors/Chart.js/dist/Chart.min.js"></script>



<!-- gauge.js -->
<script src="{{URL::to('/gentelella')}}/vendors/gauge.js/dist/gauge.min.js"></script>
<!-- bootstrap-progressbar -->
<script src="{{URL::to('/gentelella')}}/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
<!-- iCheck -->
<script src="{{URL::to('/gentelella')}}/vendors/iCheck/icheck.min.js"></script>
<!-- Skycons -->
<script src="{{URL::to('/gentelella')}}/vendors/skycons/skycons.js"></script>
<!-- Flot -->
<script src="{{URL::to('/gentelella')}}/vendors/Flot/jquery.flot.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/Flot/jquery.flot.pie.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/Flot/jquery.flot.time.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/Flot/jquery.flot.stack.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/Flot/jquery.flot.resize.js"></script>
<!-- Flot plugins -->
<script src="{{URL::to('/gentelella')}}/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/flot.curvedlines/curvedLines.js"></script>
<!-- DateJS -->
<script src="{{URL::to('/gentelella')}}/vendors/DateJS/build/date.js"></script>
<!-- JQVMap -->
<script src="{{URL::to('/gentelella')}}/vendors/jqvmap/dist/jquery.vmap.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
<!-- bootstrap-daterangepicker -->
<script src="{{URL::to('/gentelella')}}/vendors/moment/min/moment.min.js"></script>
<script src="{{URL::to('/gentelella')}}/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
...
<!-- jQuery Tags Input -->
<script src="{{URL::to('/gentelella')}}/vendors/jquery.tagsinput/src/jquery.tagsinput.js"></script>
<!-- Switchery -->
<script src="{{URL::to('/gentelella')}}/vendors/switchery/dist/switchery.min.js"></script>
<!-- Select2 -->
<script src="{{URL::to('/gentelella')}}/vendors/select2/dist/js/select2.full.min.js"></script>
<!-- Parsley -->
<script src="{{URL::to('/gentelella')}}/vendors/parsleyjs/dist/parsley.min.js"></script>
<!-- Autosize -->
