                            ...
                            <form method="post" action="{{URL::to('/do-transfer')}}" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input name="nama_rek" type="text" id="first-name" required class="form-control col-md-7 col-xs-12"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input name="no_rek" type="text" id="last-name" required class="form-control col-md-7 col-xs-12"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input name="jumlah" type="number" id="last-name" name="last-name" required class="form-control col-md-7 col-xs-12" />
                                    </div>
                                </div>
